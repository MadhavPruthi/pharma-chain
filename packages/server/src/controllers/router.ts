...
import { 
    ...
    SupplychainController_getDrugById_get,
    SupplychainController_getAllDrugs_get } from './controllers'
...
.get('/supplychain/getAllDrugs', SupplychainController_getAllDrugs_get)
